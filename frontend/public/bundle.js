 ...
 */
    ...
    (function(global) {
        ...
        const comparators = {
            ...
            courses: {
                fields: [{ key: "audit", label: "Audit" }, {
                    key: "avg",
                    label: "Average"
                }, { key: "dept", label: "Department" }, { key: "fail", label: "Fail" }, {
                    key: "id",
                    label: "ID"
                }, { key: "instructor", label: "Instructor" }, { key: "pass", label: "Pass" }, {
                    key: "title",
                    label: "Title"
                }, { key: "uuid", label: "UUID" }, { key: "year", label: "Year" }]
            },
            rooms: {
                fields: [{ key: "address", label: "Address" }, {
                    key: "fullname",
